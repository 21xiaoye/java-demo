package com.example.datastructure.snowflow;

public class SnowFlows {
    ...
    public SnowFlows(long workerId, long datacenterId, long sequence) {
...
//        System.out.println(6&4596);
//        System.out.println(6&4596);
        SnowFlows snowFlow = new SnowFlows(1, 1, 1);
        for (int i = 0; i < 22; i++) {
